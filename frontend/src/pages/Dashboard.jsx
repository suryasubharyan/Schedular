...
export default function Dashboard() {
  ...
  // ✅ LinkedIn connection state now depends on linkedinUserId only
                ...
                <div style={styles.profileBox}>
                  ...
                  >
                    ...
                    <span style={{ color: "#94a3b8", fontSize: "12px" }}>
                      {profile?.profileHeadline || "Connected to LinkedIn"}
                    </span>
                  </div>
                </div>
                    ...
                    {activeTab === "scheduled" && (
                      <div style={styles.previewActions}>
                        <div style={styles.scheduleInfo}>
                          📅 Scheduled for: {selectedPost.scheduledDate} at {selectedPost.scheduledSlot}
                        </div>
                  ...
                  <div style={styles.mainPlaceholder}>
                    {activeTab === "draft" && (
                      <>
                        ...
                        <button style={styles.createMainBtn} onClick={() => openCreateView("draft")}>
                          ✍️ Create New Draft
                        </button>
                      </>
                    )}
                    ...
                    {activeTab === "saved" && (
                      <>
                        ...
                        <button style={styles.createMainBtn} onClick={() => openCreateView("saved")}>
                          💡 Save New Idea
                        </button>
                      </>
                    )}
                ...
                <div style={{ ...styles.editorPanel, overflow: "hidden" }}>
                  ...
                  <div style={styles.profileHeader}>
                    ...
                    <div style={{ display: "flex", flexDirection: "column" }}>
                      <strong style={{ color: "#fff" }}>{profile?.name || "LinkedIn User"}</strong>
                      <span style={{ color: "#94a3b8", fontSize: "13px" }}>
                        {profile?.headline || "Upcoming post on your timeline"}
                      </span>
                    </div>
                  </div>
                        ...
                        <div style={styles.previewTop}>
                          ...
                          <div>
                            ...
                            <div style={styles.previewHeadline}>
                              {profile?.headline || "Your headline"} • Now
                            </div>
                          </div>
                        </div>
                  ...
                  <div style={styles.scheduleSection}>
                    ...
                    <div style={styles.actionButtonsRow}>
                      <button style={styles.btnOutline} onClick={() => setCurrentView("dashboard")}>
                        Discard
                      </button>
                      <button style={styles.btnOutline} onClick={() => handleSavePost("draft")}>
                        Save Draft
                      </button>
                      <button
                        style={styles.btnPrimarySmall}
                        onClick={() => handleSavePost("posted")}
                      >
                        Publish Now
                      </button>
                    </div>
                ...
                <div style={{ ...styles.calendarPanel, overflow: "hidden" }}>
                  <div style={styles.calendarHeader}>
                    ...
                    <div style={styles.legendBox}>
                      ...
                      <span style={styles.legendItem}>
                        <span style={{ ...styles.legendDot, background: "#7c3aed" }}></span>
                        My Posts
                      </span>
                      <span style={styles.legendItem}>
                        <span style={{ ...styles.legendDot, background: "#38bdf8" }}></span>
                        Scheduling Here
                      </span>
                    </div>
                  </div>
                  ...
                  <div style={styles.calendarGrid}>
                    ...
                    {calendarDays.map((day) => (
                      <div key={day.dateStr} style={styles.gridHeaderCell}>
                        {day.displayStr}
                      </div>
                    ))}
                      ...
                      <div key={time.hourStr} style={{ display: "contents" }}>
                        ...
                        {calendarDays.map((day) => {
                          const existingPost = scheduledPosts.find(
                            (p) =>
                              p.scheduledDate === day.dateStr &&
                              p.scheduledSlot?.startsWith(time.hourStr)
                          );
...
const styles = {
  ...
  linkedinEditor: { background: "#000", borderRadius: "12px", padding: "20px", border: "1px solid #1e293b" },
  linkedinTextarea: { width: "100%", height: "200px", background: "transparent", border: "none", color: "#e2e8f0", fontSize: "18px", outline: "none", resize: "none", lineHeight: "1.6", fontWeight: "400" },
  linkedinProfile: { display: "flex", alignItems: "center", gap: "12px", padding: "14px", background: "#020617", borderRadius: "12px", border: "1px solid #1e293b" },
  livePreview: { marginTop: "20px" },
  previewCard: { background: "#0a0f1c", border: "1px solid #1e293b", borderRadius: "12px", padding: "16px" },
  previewTop: { display: "flex", gap: "10px", marginBottom: "12px" },
  previewAvatar: { width: "40px", height: "40px", borderRadius: "50%" },
  previewName: { fontWeight: "600", color: "#fff", fontSize: "14px" },
  previewHeadline: { fontSize: "12px", color: "#94a3b8" },
  previewContent: { marginTop: "10px", fontSize: "15px", lineHeight: "1.6", color: "#e2e8f0", whiteSpace: "pre-wrap" },
