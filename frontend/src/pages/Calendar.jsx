          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="rounded-xl border border-slate-200 px-3.5 py-2.5 font-bold text-slate-600 transition-all duration-200
                hover:-translate-y-0.5 hover:bg-slate-100 dark:border-slate-700 dark:text-slate-300 dark:hover:bg-slate-800"
            >
              ←
            </button>
                ...
                return (
                  <button
                    ...
                    className={`flex min-h-20 flex-col items-start gap-1 rounded-xl border p-2 text-left transition-all duration-200
                      ...
                      ${isSelected ? "border-brand-500 bg-brand-50 dark:bg-brand-900/30" : "border-slate-100 bg-slate-50 dark:border-slate-800 dark:bg-slate-800/40"}
