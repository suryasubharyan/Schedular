        ...
        <div className="grid gap-6">
          ...
          <Card index={1} className="p-6 sm:p-7">
            ...
            <button
              type="button"
              onClick={toggleTheme}
              className="flex w-full items-center justify-between rounded-2xl border border-white/60 bg-white/50 px-5 py-4
                shadow-[0_1px_1px_rgba(255,255,255,0.6)_inset,0_8px_20px_-10px_rgba(15,23,42,0.2)] backdrop-blur-xl transition-all duration-300
                hover:-translate-y-0.5 hover:border-white/80 hover:bg-white/70
                dark:border-white/10 dark:bg-white/[0.05] dark:shadow-[0_1px_1px_rgba(255,255,255,0.08)_inset,0_8px_20px_-10px_rgba(0,0,0,0.4)]
                dark:hover:bg-white/[0.08]"
            >
              <span className="flex items-center gap-3 font-semibold text-slate-800 dark:text-slate-100">
                <span className="grid h-9 w-9 place-items-center rounded-xl bg-gradient-to-br from-white/80 to-white/20 text-slate-600 shadow-inner dark:from-white/10 dark:to-transparent dark:text-slate-300">
                  {theme === "dark" ? <MoonIcon className="h-5 w-5" /> : <SunIcon className="h-5 w-5" />}
                </span>
                {theme === "dark" ? "Dark mode" : "Light mode"}
              </span>
              <span className="rounded-full bg-gradient-to-r from-brand-600 to-accent-600 px-4 py-2 text-xs font-bold text-white shadow-glow">
