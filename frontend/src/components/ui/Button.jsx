const VARIANTS = {
  ...
  secondary:
    "bg-white text-slate-700 border border-slate-200 hover:bg-slate-50 hover:-translate-y-0.5 dark:bg-slate-800 dark:text-slate-200 dark:border-slate-700 dark:hover:bg-slate-700 focus-visible:ring-slate-400",
  danger:
