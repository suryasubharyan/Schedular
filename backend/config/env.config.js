...
const config = {
  mongoUri: ENV === "local" ? process.env.MONGO_URI_LOCAL : process.env.MONGO_URI_PROD,
  backendUrl:
    ENV === "local"
  ...
  frontendUrl: ENV === "local" ? process.env.FRONTEND_URL_LOCAL : process.env.FRONTEND_URL_PROD,
};
